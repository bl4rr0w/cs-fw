...
#[map]
static mut WHITELIST: LruHashMap<Ipv4Addr, DummyValue> = LruHashMap::with_max_entries(75_000_000);

#[map]
static mut TEMPLIST: LruHashMap<Ipv4Addr, DummyValue> = LruHashMap::with_max_entries(75_000_000);
...
pub unsafe fn filter(ctx: XdpContext) -> XdpResult {
    ...
    let source_address = iph.source_addr;
    let destination_address = iph.destination_addr;
